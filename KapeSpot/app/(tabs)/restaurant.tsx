    ...
    return (
        <ThemedView style={styles.container}>
            ...
            <ThemedView style={styles.navbar}>
                ...
                <ThemedView style={styles.navbarLinks}>
                    <Link href="/" asChild>
                        <TouchableOpacity style={styles.navLink}>
                            <ThemedText style={styles.navLinkText}>Home</ThemedText>
                        </TouchableOpacity>
                    </Link>
                    <Link href="/explore" asChild>
                        <TouchableOpacity style={styles.navLink}>
                            <ThemedText style={styles.navLinkText}>Explore</ThemedText>
                        </TouchableOpacity>
                    </Link>
                    <TouchableOpacity style={[styles.navLink, styles.activeNavLink]}>
                        <ThemedText style={[styles.navLinkText, styles.activeNavLinkText]}>Restaurant</ThemedText>
                    </TouchableOpacity>
                </ThemedView>
            </ThemedView>
                ...
                <ThemedView style={styles.menuSection}>
                    ...
                    <ScrollView style={styles.menuList}>
                        {filteredItems.map((item) => (
                            <ThemedView key={item.id} style={styles.menuItem} onTouchEnd={() => addToCart(item)}>
